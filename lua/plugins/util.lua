  ...
  ---   url: https://github.com/Shatur/neovim-session-manager#commands
  {
    ...
    config = function()
      ...
      require("session_manager").setup({
        autoload_mode = { mode.GitSession, mode.CurrentDir, mode.LastSession }, -- Define what to do when Neovim is started without arguments. See "Autoload mode" section below.
