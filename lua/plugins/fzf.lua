...
return {
  ...
  -- stylua: ignore
	keys = {
		...
		{ "<leader>fF", "<cmd>lua require'fzf-lua'.live_grep{cwd=require'util.root'{follow=true}}<cr>", desc = "Grep Files", },
		...
		{ '<leader>f<space>', "<cmd>FzfLua<cr>", desc = "Find register" },
		{ '<leader>f<cr>', "<cmd>FzfLua resume<cr>", desc = "Find register" },
		-- git
